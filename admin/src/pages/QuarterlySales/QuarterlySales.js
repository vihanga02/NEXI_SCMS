...
import Sidebar from '../../components/Sidebar/Sidebar.js';  // Sidebar component
import Topbar from '../../components/Topbar/Topbar.js';    // Topbar component
    ...
    useEffect(() => {
        const fetchQuarterlySales = async () => {
            ...
            try {
                ...
                const response = await axios.get('http://localhost:3001/admin/quarterlySales', {
